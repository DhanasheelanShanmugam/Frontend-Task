import { DragHelper, Scheduler, WidgetHelper, Toast, CrudManager, SchedulerEventModel } from '../../build/schedulerpro.module.js';
...
class SideMenu extends React.Component {
    ...
    render() {
        return (e(React.Fragment, null, e("div", {
            ...
            className: "task-list"
        }, unplannedItems.map((item, idx) => e("li", {
            draggable: true,
            key: idx,
            onDrag: () => this.onDrag(item)
        }, item.name, " \xA0", e("span", { className: "float-right" }, null, item.duration + item.durationUnit))))))
        );
    }
}
